...
public partial class GameEntity {
    ...
    static readonly Code.Gameplay.Features.Armaments.Bomb bombComponent = new Code.Gameplay.Features.Armaments.Bomb();

    public bool isBomb {
        get { return HasComponent(GameComponentsLookup.Bomb); }
        set {
            if (value != isBomb) {
