...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Enchants.Behaviors.EnchantHolder EnchantHolder { get { return enchantHolder.Value; } }
    public bool hasEnchantHolder { get { return HasComponent(GameComponentsLookup.EnchantHolder); } }

    public GameEntity AddEnchantHolder(Code.Gameplay.Features.Enchants.Behaviors.EnchantHolder newValue) {
    ...
    public GameEntity ReplaceEnchantHolder(Code.Gameplay.Features.Enchants.Behaviors.EnchantHolder newValue) {
        var index = GameComponentsLookup.EnchantHolder;
        var component = (Code.Gameplay.Features.Enchants.EnchantHolderComponent)CreateComponent(index, typeof(Code.Gameplay.Features.Enchants.EnchantHolderComponent));
        component.Value = newValue;
